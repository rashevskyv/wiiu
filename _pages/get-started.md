...
На данный момент, самая дешёвая подходящая игра в eShop - Brain Age ($6.99 USD).
...
1. Перейдите на сайт `usploit.hacks.guide`
	* Если такой кнопки нет, сначала выберите вашу прошивку (пользователи 5.5.3 так же выбирают 5.5.2)
1. Нажмите (X), чтобы открыть шторки на телевизоре, если они закрыты. Если не закрыты - откройте и закройте
