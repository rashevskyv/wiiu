...
+ Свежая версия [Wii U USB Helper](https://application.wiiuusbhelper.com/Updater.exe)

### Часть I - Получаем установочные файлы игры

1. Запустите Updater.exe 
1. Укажите адрес для установки
	+ Имейте в виду. что программа ставится ровно в ту папку, которую вы укажите, так что можете создать папку специально для неё
1. Программа попросит выбрать регион вашей консоли и согласиться с лицензионным соглашением
	1. Поставьте галочку напротив надписи "I agree these terms and EULA"
	1. Выберите регион, соответствующий региону вашей приставки
1. Закройте выскочившее предупреждение, нажав кнопку ОК
1. Закройте ещё одно ненавязчивое окно, говорящее о том, что следует выбрать папку для хранения игр, нажав ОК
1. Выберите папку, в которую программа будет скачивать игры.
1. В следующем окне нужно ввести ключи для 
	+ Wii U: `http://wiiu.titlekeys.gq/`
	+ 3DS (если необходимо): `http://3ds.titlekeys.gq/`
