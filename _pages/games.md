...
#### <a name="wiiu_part1" />Часть I - Получаем установочные файлы игры
...
#### <a name="wiiu_part2" />Часть II - Установка игры в WiiU
...
#### <a name="prep_ulg" />Подготовительные работы:
...
#### <a name="instruction_ulg" />Инструкция:
...
#### <a name="prep_wad" />Подготовительные работы:
...
#### <a name="instruction_wad" />Инструкция:
...
+ [Nintendont.zip](https://yadi.sk/d/Zd7B0vbd3KiX6K)
+ [DIOS MIOS Toolbox 2.11](https://yadi.sk/d/c-f8sPvQ3KiZ2V)


#### <a name="prep_gc" />Подготовительные работы:
...
#### <a name="gc_install" />Установка Gamecube-игр на носитель
...
1. Перейдите в меню "Loader Settings" и в нем "Gamecube Mode", выставите там "Nintendont". Так же в настройках USB Loader GX можно выставить поддержку широкоформатного изображения для GameCube; прописать пути, где будут находиться GameCube игры на USB носителе и/или SD карте а так же многое другое. 
{% endcomment %} 