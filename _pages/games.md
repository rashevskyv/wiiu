...
#### <a name="wiiu_what_need" />Что понадобится:
...
#### <a name="wiiu_get_games" />Часть I - Получаем установочные файлы игры
...
#### <a name="wiiu_install" />Часть II - Установка игры в WiiU
...
## <a name="wii" />Установка и запуск игр для vWii
...
#### <a name="wii_what_need" />Что понадобится:
...
## <a name="wii_launch_ulg" />Запуск Wii-игр в vWii через USB Loader GX

#### <a name="what_need_ulg" />Что понадобится:

* vWii режим должен быть взломан. Если вы не делали этого, перейдите на [соответствующую страницу гайда](vwii-modding). Если вы купили приставку у меня (в [VK](https://vk.com/market-125012133) или на [OLX](https://www.olx.ua/list/user/1nlHd/), то vWii режим уже взломан. 
* [USBLoaddrGX r1262.7z](https://yadi.sk/d/CYaSr-N33KkYpn)

#### <a name="prep_ulg" />Часть I - Подготовительные работы:

Пропустите эту часть, если у вас уже установлен USB Loader GX
{: .notice--info}
...
#### <a name="instruction_ulg" />Часть II - Инструкция:

USB Loader GX работает только с USB-носителем. Игры записанные на SD-карту работать не будут! USB-носитель нужно вставлять в верхний порт приставки, если приставка лежит горизонтально. 
{: .notice--info}
...
## <a name="wii_launch_wf" />Запуск Wii-игр в vWii через WiiFlow

#### <a name="what_need_wf" />Что понадобится:

* vWii режим должен быть взломан. Если вы не делали этого, перейдите на [соответствующую страницу гайда](vwii-modding). Если вы купили приставку у меня (в [VK](https://vk.com/market-125012133) или на [OLX](https://www.olx.ua/list/user/1nlHd/), то vWii режим уже взломан. 
* [WiiFlow 4.2.1](https://yadi.sk/d/q397XtTJ3KgKqq)

#### <a name="prep_wf" />Часть I - Подготовительные работы:
...
#### <a name="instruction_wf" />Часть II - Инструкция:
...
## <a name="wii_install_wad" />Установка WiiWare и WiiVC
...
#### <a name="what_need_wad" />Что понадобится:

+ vWii режим должен быть взломан. Если вы не делали этого, перейдите на [соответствующую страницу гайда](vwii-modding). Если вы купили приставку у меня (в [VK](https://vk.com/market-125012133) или на [OLX](https://www.olx.ua/list/user/1nlHd/), то vWii режим уже взломан. 
* [YAWMM_EN](https://yadi.sk/d/jOffWhsa3KgLRa)

#### <a name="prep_wad" />Часть I - Подготовительные работы:
...
#### <a name="instruction_wad" />Часть II - Инструкция:
...
## <a name="wii_install_gc" />Установка игр от Gameсube

#### <a name="what_need_gc" />Что понадобится:
...
#### <a name="prep_gc" />Часть I - Подготовительные работы:
...
#### <a name="gc_install" />Часть II - Установка Gamecube-игр на носитель

vWii игры запускаются через загрузчик Nintendont, который использует встроенный в Wii эмулятор Gamecube и позволяет использовать сторонние контроллеры вместо джойстиков от GC. По-умолчанию поддерживаются следующие джойстики:
	+ В беспроводном режиме: Wii U Pro Controller, Wii Classic Controller / Pro
	+ В проводном режиме, по USB: DualShock 3, DualShock 4 и некоторые другие      
Gamecube игры можно устанавливать на USB-носитель, либо на SD-карту. Выбранный носитель должен быть отформатирован в FAT32.      
Установка игр на носитель производится через програму DIOS MIOS Toolbox. Образы Gamecube-игр должны быть в формате `.ISO`, или `.gcm`
{: .notice--info}
...
1. Вставьте носитель в приставку
	+ USB-носитель вставьте в верхний порт горизонтально-лежащей Wii U
	+ SD-карту вставьте в SD-слот приставки
	
#### <a name="gc_setup" />Часть III - Настройка USB Loader GX и Nintendont
...
#### <a name="gc_launch" />Часть IV - Запуск Gamecube-игр
...
За подробной инструкцией обратитесь к [официальной ветке](https://gbatemp.net/threads/nintendont.349258/#Nintendont) программы на gbatemp.
{: .notice--info}