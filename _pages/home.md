...
header:
  ...
  cta_url: "/get-started" #
  caption:
excerpt: "Полное руководство пользователей по кастомной прошивке Wii U, <br /> от начала до Coldboot Haxchi<br /><br />**Последнее изменение: <br />26 июня 2017<br /><br />**"
permalink: /
sidebar:
  nav: "home"
---
...
+ Это руководство применимо к любой Wii U любого региона, находящуюся на последней прошивке.
