...
**Об ошибках и неточностях просьба рапортовать [сюда](http://tg.customfw.xyz)**
{: .notice--warning}
...
Конечная цель этого руководства — перевести полностью немодифицированную Wii U со стандартной прошивки на кастомную прошивку
...
## Если ваша приставка уже модифицирована, то вам нужно удалить предыдущий взлом 

* [Удаление взлома](uninstall-hack){:target="_blank"}
* При запуске эксплойта через браузер продолжайте следовать руководству 
